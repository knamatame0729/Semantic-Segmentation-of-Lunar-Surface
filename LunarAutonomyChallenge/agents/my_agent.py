...
class KeyboardControl(object):
    ...
    def __init__(self, agent):
        ...
        self.front_arm_target_angle = 1.57
...
class HumanAgent(AutonomousAgent, Node):
    def setup(self, path_to_conf_file):
        ...
        # =============================================
        rclpy.init()
        Node.__init__(self, 'lac_ros2_node')
        self._sensors = self.sensors()
        self._publisher = ROS2Publisher(self._sensors)
        # =============================================
    ...
    def sensors(self):
        sensors = {
            carla.SensorPosition.Front: {
                'camera_active': False, 'light_intensity': 1.0, 'width': self._width, 'height': self._height, 'use_semantic': True
            },
    ...
    def run_step(self, input_data):
        self._hic._pygame_clock.tick_busy_loop(20)
        ...
        """ Publishing both graysclae image and semantic image """
        self._publisher.publish_images(input_data.get('Grayscale', {}), input_data.get('Semantic', {}))
